...
v = np.empty(shape, dtype=dtype)
path = "/home/joao.santana/cluster_gas/code_rtm_implemnte/code_with_matplot/kv2/V_400x200_chamine.bin"
a = open(path)
v = np.fromfile(a, dtype=dtype).reshape([nx, nz])
v = v / 1000
a.close()

path_2 = "/home/joao.santana/cluster_gas/code_rtm_implemnte/code_with_matplot/kv2/Q_400x200_chamine.bin"
c = open(path)
