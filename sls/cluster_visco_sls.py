...
path = "/home/joao.santana/visco_cluster/code_rtm_implemnte/sls/marmousi-resample-738x240.bin"
a = open(path)
...
d0.data.tofile('sismogram_real.bin')
d1.data.tofile('sismogram_smooth.bin')
